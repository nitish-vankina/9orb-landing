...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-base-800 bg-base-950/85 backdrop-blur">
      <div className="mx-auto flex h-16 w-full max-w-content items-center justify-between px-6 md:px-8">
        <Logo />
        ...
        <div className="hidden items-center gap-3 lg:flex">
          <Button href={siteConfig.signInUrl} external variant="ghost" size="md">
            Sign In
          </Button>
        ...
        <button
          type="button"
          className="flex h-9 w-9 items-center justify-center rounded-md border border-base-700 text-ink-200 lg:hidden"
      ...
      {open ? (
        <div
          id="mobile-menu"
          className="border-t border-base-800 bg-base-950 px-6 py-6 lg:hidden"
        >
